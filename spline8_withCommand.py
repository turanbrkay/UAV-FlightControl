...
def add_mission():
    ...
    command.add(Command(0,0,0,mavutil.mavlink.MAV_FRAME_GLOBAL_RELATIVE_ALT,mavutil.mavlink.MAV_CMD_NAV_SPLINE_WAYPOINT,0,0,0,0,0,0,upper[0],upper[1],10))
    command.add(Command(0,0,0,mavutil.mavlink.MAV_FRAME_GLOBAL_RELATIVE_ALT,mavutil.mavlink.MAV_CMD_NAV_SPLINE_WAYPOINT,0,0,0,0,0,0,rightUp[0],rightUp[1],10))
    ...
    command.add(Command(0,0,0,mavutil.mavlink.MAV_FRAME_GLOBAL_RELATIVE_ALT,mavutil.mavlink.MAV_CMD_NAV_SPLINE_WAYPOINT,0,0,0,0,0,0,lower[0],lower[1],10))
    command.add(Command(0,0,0,mavutil.mavlink.MAV_FRAME_GLOBAL_RELATIVE_ALT,mavutil.mavlink.MAV_CMD_NAV_SPLINE_WAYPOINT,0,0,0,0,0,0,rightLow[0],rightLow[1],10))
...
while True:
    ...
    if next_waypoint ==3:
        print("next_waypoint == 3 /// wpnav_speed : ", vehicle.parameters['WPNAV_SPEED'])
    if  next_waypoint == 4:
        vehicle.parameters['WPNAV_SPEED']=1500
        vehicle.parameters['WPNAV_ACCEL']=250
        print("next_waypoint == 4 /// wpnav_speed : ", vehicle.parameters['WPNAV_SPEED'])
    if  next_waypoint == 5:
        vehicle.parameters['WPNAV_SPEED']=600
        vehicle.parameters['WPNAV_ACCEL']=150
        print("next_waypoint == 4 /// wpnav_speed : ", vehicle.parameters['WPNAV_SPEED'])
    if next_waypoint == 11:
